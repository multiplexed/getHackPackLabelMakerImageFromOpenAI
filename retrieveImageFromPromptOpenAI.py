# Some code derived from files from https://github.com/DevMiser
...
def getAIGeneratedImageURL(image_prompt):
    try:
        ...
        openAIImagePrompt = "Generate a cartoon black and white outline pixel art illustration featuring a " + image_prompt + ", featuring a central centered object on a white background"
...
try:
    ...
    openai_image_url = getAIGeneratedImageURL(args.prompt)
    ...
    if imageData.status_code == 200:
        with open('local_image.png', 'wb') as image_file:
